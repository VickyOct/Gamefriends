...
class PersonalInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create personal_info" do
    assert_difference("PersonalInfo.count") do
      post personal_infos_url, params: { personal_info: { age: @personal_info.age, country: @personal_info.country, phone: @personal_info.phone, twitter: @personal_info.twitter } }
    end
  ...
  test "should update personal_info" do
    patch personal_info_url(@personal_info), params: { personal_info: { age: @personal_info.age, country: @personal_info.country, phone: @personal_info.phone, twitter: @personal_info.twitter } }
